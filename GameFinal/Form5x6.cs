...
namespace GameFinal
{
    public partial class Form5x6 : Form
    {
        ...
        Image img = Properties.Resources.logo5x6;
        public Form5x6()
        {
            InitializeComponent();
            AddPicture();
        ...
        {
            timer1.Stop();
            firstClick.Image = Properties.Resources.logo5x6;
            secondClick.Image = Properties.Resources.logo5x6;
            firstClick = null;
            secondClick = null;
        }
        ...
        private void AddPicture() //add picture to gameform
        {
            ...
            for (int i = 0; i < tableLayoutPanel1.Controls.Count; i++)
            {
                ...
                picBox.Image = Properties.Resources.logo5x6;
